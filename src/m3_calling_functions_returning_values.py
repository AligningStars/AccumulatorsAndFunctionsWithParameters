...
def run_test_sum_of_digits():
    ...
    #    So read
    #    defined below.  Be sure that you understand frothe doc-string of the  sum_of_digits  functionm the
